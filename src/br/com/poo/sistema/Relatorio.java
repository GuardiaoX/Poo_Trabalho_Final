...
public abstract class Relatorio {
	...
	public static void comprovanteTransferencia(Conta remetente, Conta destinatario, BigDecimal valor) throws IOException {
	...
	public static void relatorioCapitalDoBanco(BigDecimal valor) throws IOException {
		...
		try (BufferedWriter buffWrite = new BufferedWriter(new FileWriter(PATH_BASICO + nomeArquivo + EXTENSAO))) {
			...
			linha = "===============================================";
			buffWrite.append(linha + "\n");
			linha = "A capital total do Banco é: " + valor;
			buffWrite.append(linha + "\n");
			linha = "Realizado em: " + sdf.format(date);
			buffWrite.append(linha + "\n");
			linha = "===============================================";
